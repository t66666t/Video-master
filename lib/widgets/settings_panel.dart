...
class SettingsPanel extends StatefulWidget {
  ...
  final ValueChanged<double> onSpeedLongPress;
                ...
                if (widget.isAudioMode) ...[
                  ...
                  Container(
                    ...
                    child: SwitchListTile(
                      ...
                      onChanged: widget.onSyncAudioSubtitleStyleWithVideoChanged,
                          ...
                          children: [0.25, 0.5, 0.75, 1.0, 1.25, 1.5, 2.0, 2.5, 3.0, 4.0, 5.0].map((speed) {
                            return _buildCompactChip(
                              ...
                              isSelected: (speed - widget.playbackSpeed).abs() < 0.1,
                                trailingIcon: widget.isPlaybackSpeedLocked &&
                                        widget.lockedPlaybackSpeed != null &&
                                        (speed - widget.lockedPlaybackSpeed!).abs() < 0.1
                                    ? Icons.lock
                                    : null,
                              onTap: () => widget.onSpeedChanged(speed),
                                onLongPress: () => widget.onSpeedLongPress(speed),
                            );
                          }).toList(),
                        ),
                      ),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      SwitchListTile(
                        title: const Text("自动连播", style: TextStyle(color: Colors.white70, fontSize: 13)),
                        subtitle: const Text("当前媒体播放完后自动播放下一个；若已到末尾则回到播放列表第一个", style: TextStyle(color: Colors.white30, fontSize: 10)),
                      ...
                      SwitchListTile(
                        title: const Text("自动连播时从头开始播放", style: TextStyle(color: Colors.white70, fontSize: 13)),
                        subtitle: Text(
